...
class ThirdPartyMarketplaceOrderExporter extends Controller
{
    ...
    {
        $query = ThirdPartyMarketplaceOrder::query();
    ...
    {
        Log::info('ThirdPartyMarketplaceOrder CSV export requested');
        ...
        $columns = (new ThirdPartyMarketplaceOrder)->getFillable();
        ...
        $filename = 'third_party_marketplace_orders_' .
    ...
    {
        Log::info('ThirdPartyMarketplaceOrder JSON export requested');
        ...
        try {
            ...
            Log::error('ThirdPartyMarketplaceOrder export JSON error', [
                'error' => $e->getMessage(),
            ]);
            return response()->json([
                'success' => false,
    ...
    {
        Log::info('ThirdPartyMarketplaceOrder Excel export requested');
